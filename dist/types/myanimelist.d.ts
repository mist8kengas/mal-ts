export declare enum AnimeField {
...
export declare enum MangaField {
    /** "synonyms" or ISO 639-1 */
    ALTERNATIVE_TITLES = "alternative_titles",
    START_DATE = "start_date",
    END_DATE = "end_date",
...
export declare enum MANGA_MEDIA_TYPE {
    UNKNOWN = "unknown",
    MANGA = "manga",
    NOVEL = "novel",
    ONE_SHOT = "one_shot",
...
export declare enum ANIME_RATING {
    /** G - All Ages */
    G_ALL_AGES = "g",
    /** PG - Children */
    PG_CHILDREN = "pg",
...
export declare enum ANIME_SOURCE {
    OTHER = "other",
    ORIGINAL = "original",
    MANGA = "manga",
